...
urlpatterns = [
    ...
    url(r'^userinfo/(?P<uid>[0-9]+)$', index.scanuserinfo, name="userinfo"),
    url(r'^userinfoedit/(?P<uid>[0-9]+)$', index.userinfoedit, name="userinfoedit"),
    url(r'^userinfoedit/(?P<uid>[0-9]+)$', index.userinfoedit, name="userinfoedit"),
    url(r'^reset/(?P<uid>[0-9]+)$', index.reset, name="reset"),
    url(r'^resetpassword$', index.restpassword, name="resetpassword"),
